...
left=amplifier(13,:)-amplifier(19,:);
right=amplifier(13,:)-amplifier(3,:);
stim=amplifier(1,:);
...
for i=1:length(num)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    name=sprintf('Ativo/ChanStim%g',aux);
...
for i=1:length(num)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    name=sprintf('Ativo/Stim%g',i);
    name2=sprintf('Ativo/Stim2_%g',i);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    save(name,'samples')
    save(name2,'samples2')
...
for j=1:length(num)
    ...
    if mod(j,2)==1
        count=count+1;
        load(sprintf('Ativo/Stim%d.mat',j))
        ...
        load(sprintf('Ativo/Stim%d.mat',j+1))
        baseline=mean(mean(samples(1,1:(0.1*rate),:),3));
