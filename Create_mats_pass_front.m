...
left0=mean([(amplifier(13,:)-amplifier(16,:));(amplifier(13,:)-amplifier(7,:))],1);
right0=mean([(amplifier(13,:)-amplifier(8,:));(amplifier(13,:)-amplifier(9,:));(amplifier(13,:)-amplifier(18,:))],1);
stim0=amplifier(1,:);
...
for i=1:length(num)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    name=sprintf('PassivoFront/ChanStim%g',aux);
...
for i=1:length(num)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    name=sprintf('PassivoFront/Stim%g',i);
    name2=sprintf('PassivoFront/Stim2_%g',i);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    save(name,'samples')
    save(name2,'samples2')
...
for j=1:length(num)
    ...
    if mod(j,2)==1
        count=count+1;
        load(sprintf('PassivoFront/Stim%d.mat',j))
        ...
        load(sprintf('PassivoFront/Stim%d.mat',j+1))
        baseline=mean(mean(samples(1,1:(0.1*rate),:),3));
