...
count=count+1;
        ...
        Xica_DWT_rec(2,:)=(Xica_DWT_rec(2,:)-medR)/sdR;
        Xica_DWT_rec(17,:)=(Xica_DWT_rec(17,:)-medL)/sdL;
        ampVOTpass.right.vales(count,stim)=(find(-Xica_DWT_rec(2,mN1:1000)==min(-Xica_DWT_rec(2,mN1:1000))))+(mN1-1);
        ampVOTpass.right.p1(count,stim)=(find(-Xica_DWT_rec(2,50:550)==max(-Xica_DWT_rec(2,50:550))))+49;
        ampVOTpass.right.N2(count,stim)=(find(-Xica_DWT_rec(2,1300:1900)==min(-Xica_DWT_rec(2,1300:1900))))+1299;
        ampVOTpass.right.N2_val(count,stim)=-Xica_DWT_rec(2,ampVOTpass.right.N2(count,stim));
        ampVOTpass.right.picos(count,stim)=(find(-Xica_DWT_rec(2,500:1500)==max(-Xica_DWT_rec(2,500:1500))))+499;
        ampVOTpass.right.diffsp1(count,stim)= -Xica_DWT_rec(2,ampVOTpass.right.p1(count,stim))-(-Xica_DWT_rec(2,ampVOTpass.right.vales(count,stim)));
        ampVOTpass.right.diffs(count,stim)= -Xica_DWT_rec(2,ampVOTpass.right.picos(count,stim))-(-Xica_DWT_rec(2,ampVOTpass.right.vales(count,stim)));
        ampVOTpass.right.picos_val(count,stim)=-Xica_DWT_rec(2,ampVOTpass.right.picos(count,stim));
        ampVOTpass.right.vales_val(count,stim)=-Xica_DWT_rec(2,ampVOTpass.right.vales(count,stim));
        ampVOTpass.right.p1_val(count,stim)=-Xica_DWT_rec(2,ampVOTpass.right.p1(count,stim));
        ...
        ampVOTpass.right.meio_val(count,stim)=-Xica_DWT_rec(2,(ampVOTpass.right.vales(count,stim)+round((ampVOTpass.right.picos(count,stim)-ampVOTpass.right.vales(count,stim))/2)));
        
        ampVOTpass.left.vales(count,stim)=(find(-Xica_DWT_rec(17,mN1:1000)==min(-Xica_DWT_rec(17,mN1:1000))))+(mN1-1);
        ampVOTpass.left.p1(count,stim)=(find(-Xica_DWT_rec(17,50:550)==max(-Xica_DWT_rec(17,50:550))))+49;
        ampVOTpass.left.N2(count,stim)=(find(-Xica_DWT_rec(17,1300:1900)==min(-Xica_DWT_rec(17,1300:1900))))+1299;
        ampVOTpass.left.N2_val(count,stim)=-Xica_DWT_rec(17,ampVOTpass.right.N2(count,stim));
        ampVOTpass.left.picos(count,stim)=(find(-Xica_DWT_rec(17,500:1500)==max(-Xica_DWT_rec(17,500:1500))))+499;
        ampVOTpass.left.diffsp1(count,stim)= -Xica_DWT_rec(17,ampVOTpass.left.p1(count,stim))-(-Xica_DWT_rec(17,ampVOTpass.left.vales(count,stim)));
        ampVOTpass.left.diffs(count,stim)= -Xica_DWT_rec(17,ampVOTpass.left.picos(count,stim))-(-Xica_DWT_rec(17,ampVOTpass.left.vales(count,stim)));
        ampVOTpass.left.picos_val(count,stim)=-Xica_DWT_rec(17,ampVOTpass.left.picos(count,stim));
        ampVOTpass.left.vales_val(count,stim)=-Xica_DWT_rec(17,ampVOTpass.left.vales(count,stim));
        ampVOTpass.left.p1_val(count,stim)=-Xica_DWT_rec(17,ampVOTpass.left.p1(count,stim));
        ...
        ampVOTpass.left.meio_val(count,stim)=-Xica_DWT_rec(17,(ampVOTpass.left.vales(count,stim)+round((ampVOTpass.left.picos(count,stim)-ampVOTpass.left.vales(count,stim))/2)));
        ...
        Xica_DWT_rec(2,:)=(Xica_DWT_rec(2,:)-medR)/sdR;
        Xica_DWT_rec(17,:)=(Xica_DWT_rec(17,:)-medL)/sdL;
        ampVOTact.right.vales(count,stim)=(find(-Xica_DWT_rec(2,mN1:1000)==min(-Xica_DWT_rec(2,mN1:1000))))+(mN1-1);
        ampVOTact.right.p1(count,stim)=(find(-Xica_DWT_rec(2,50:550)==max(-Xica_DWT_rec(2,50:550))))+49;
        ampVOTact.right.N2(count,stim)=(find(-Xica_DWT_rec(2,1300:1900)==min(-Xica_DWT_rec(2,1300:1900))))+1299;
        ampVOTact.right.N2_val(count,stim)=-Xica_DWT_rec(2,ampVOTact.right.N2(count,stim));
        ampVOTact.right.picos(count,stim)=(find(-Xica_DWT_rec(2,500:1500)==max(-Xica_DWT_rec(2,500:1500))))+499;
        ampVOTact.right.diffsp1(count,stim)= -Xica_DWT_rec(2,ampVOTact.right.p1(count,stim))-(-Xica_DWT_rec(2,ampVOTact.right.vales(count,stim)));
        ampVOTact.right.diffs(count,stim)= -Xica_DWT_rec(2,ampVOTact.right.picos(count,stim))-(-Xica_DWT_rec(2,ampVOTact.right.vales(count,stim)));
        ampVOTact.right.picos_val(count,stim)=-Xica_DWT_rec(2,ampVOTact.right.picos(count,stim));
        ampVOTact.right.vales_val(count,stim)=-Xica_DWT_rec(2,ampVOTact.right.vales(count,stim));
        ampVOTact.right.p1_val(count,stim)=-Xica_DWT_rec(2,ampVOTact.right.p1(count,stim));
        ...
        ampVOTact.right.meio_val(count,stim)=-Xica_DWT_rec(2,(ampVOTact.right.vales(count,stim)+round((ampVOTact.right.picos(count,stim)-ampVOTact.right.vales(count,stim))/2)));
                
        ampVOTact.left.vales(count,stim)=(find(-Xica_DWT_rec(17,mN1:1000)==min(-Xica_DWT_rec(17,mN1:1000))))+(mN1-1);
        ampVOTact.left.p1(count,stim)=(find(-Xica_DWT_rec(17,50:550)==max(-Xica_DWT_rec(17,50:550))))+49;
        ampVOTact.left.N2(count,stim)=(find(-Xica_DWT_rec(17,1300:1900)==min(-Xica_DWT_rec(17,1300:1900))))+1299;
        ampVOTact.left.N2_val(count,stim)=-Xica_DWT_rec(17,ampVOTact.right.N2(count,stim));
        ampVOTact.left.picos(count,stim)=(find(-Xica_DWT_rec(17,500:1500)==max(-Xica_DWT_rec(17,500:1500))))+499;
        ampVOTact.left.diffsp1(count,stim)= -Xica_DWT_rec(17,ampVOTact.left.p1(count,stim))-(-Xica_DWT_rec(17,ampVOTact.left.vales(count,stim)));
        ampVOTact.left.diffs(count,stim)= -Xica_DWT_rec(17,ampVOTact.left.picos(count,stim))-(-Xica_DWT_rec(17,ampVOTact.left.vales(count,stim)));
        ampVOTact.left.picos_val(count,stim)=-Xica_DWT_rec(17,ampVOTact.left.picos(count,stim));
        ampVOTact.left.vales_val(count,stim)=-Xica_DWT_rec(17,ampVOTact.left.vales(count,stim));
        ampVOTact.left.p1_val(count,stim)=-Xica_DWT_rec(17,ampVOTact.left.p1(count,stim));
        ...
        ampVOTact.left.meio_val(count,stim)=-Xica_DWT_rec(17,(ampVOTact.left.vales(count,stim)+round((ampVOTact.left.picos(count,stim)-ampVOTact.left.vales(count,stim))/2)));
        ...
        Xica_DWT_rec(2,:)=(Xica_DWT_rec(2,:)-medR)/sdR;
        Xica_DWT_rec(17,:)=(Xica_DWT_rec(17,:)-medL)/sdL;
        ampFormpass.right.vales(count,stim)=(find(-Xica_DWT_rec(2,353:1000)==min(-Xica_DWT_rec(2,353:1000))))+352;
        ampFormpass.right.p1(count,stim)=(find(-Xica_DWT_rec(2,50:550)==max(-Xica_DWT_rec(2,50:550))))+49;
        ampFormpass.right.N2(count,stim)=(find(-Xica_DWT_rec(2,1300:1900)==min(-Xica_DWT_rec(2,1300:1900))))+1299;
        ampFormpass.right.N2_val(count,stim)=-Xica_DWT_rec(2,ampFormpass.right.N2(count,stim));
        ampFormpass.right.picos(count,stim)=(find(-Xica_DWT_rec(2,500:1500)==max(-Xica_DWT_rec(2,500:1500))))+499;
        ampFormpass.right.diffsp1(count,stim)= -Xica_DWT_rec(2,ampFormpass.right.p1(count,stim))-(-Xica_DWT_rec(2,ampFormpass.right.vales(count,stim)));
        ampFormpass.right.diffs(count,stim)= -Xica_DWT_rec(2,ampFormpass.right.picos(count,stim))-(-Xica_DWT_rec(2,ampFormpass.right.vales(count,stim)));
        ampFormpass.right.picos_val(count,stim)=-Xica_DWT_rec(2,ampFormpass.right.picos(count,stim));
        ampFormpass.right.vales_val(count,stim)=-Xica_DWT_rec(2,ampFormpass.right.vales(count,stim));
        ampFormpass.right.p1_val(count,stim)=-Xica_DWT_rec(2,ampFormpass.right.p1(count,stim));
        ...
        ampFormpass.right.meio_val(count,stim)=-Xica_DWT_rec(2,(ampFormpass.right.vales(count,stim)+round((ampFormpass.right.picos(count,stim)-ampFormpass.right.vales(count,stim))/2)));
                
        ampFormpass.left.vales(count,stim)=(find(-Xica_DWT_rec(17,253:1000)==min(-Xica_DWT_rec(17,253:1000))))+352;
        ampFormpass.left.p1(count,stim)=(find(-Xica_DWT_rec(17,50:550)==max(-Xica_DWT_rec(17,50:550))))+49;
        ampFormpass.left.N2(count,stim)=(find(-Xica_DWT_rec(17,1300:1900)==min(-Xica_DWT_rec(17,1300:1900))))+1299;
        ampFormpass.left.N2_val(count,stim)=-Xica_DWT_rec(17,ampFormpass.right.N2(count,stim));
        ampFormpass.left.picos(count,stim)=(find(-Xica_DWT_rec(17,500:1500)==max(-Xica_DWT_rec(17,500:1500))))+499;
        ampFormpass.left.diffsp1(count,stim)= -Xica_DWT_rec(17,ampFormpass.left.p1(count,stim))-(-Xica_DWT_rec(17,ampFormpass.left.vales(count,stim)));
        ampFormpass.left.diffs(count,stim)= -Xica_DWT_rec(17,ampFormpass.left.picos(count,stim))-(-Xica_DWT_rec(17,ampFormpass.left.vales(count,stim)));
        ampFormpass.left.picos_val(count,stim)=-Xica_DWT_rec(17,ampFormpass.left.picos(count,stim));
        ampFormpass.left.vales_val(count,stim)=-Xica_DWT_rec(17,ampFormpass.left.vales(count,stim));
        ampFormpass.left.p1_val(count,stim)=-Xica_DWT_rec(17,ampFormpass.left.p1(count,stim));
        ...
        ampFormpass.left.meio_val(count,stim)=-Xica_DWT_rec(17,(ampFormpass.left.vales(count,stim)+round((ampFormpass.left.picos(count,stim)-ampFormpass.left.vales(count,stim))/2)));
        ...
        Xica_DWT_rec(2,:)=(Xica_DWT_rec(2,:)-medR)/sdR;
        Xica_DWT_rec(17,:)=(Xica_DWT_rec(17,:)-medL)/sdL;
        ampFormact.right.vales(count,stim)=(find(-Xica_DWT_rec(2,mN1:1000)==min(-Xica_DWT_rec(2,mN1:1000))))+(mN1-1);
        ampFormact.right.p1(count,stim)=(find(-Xica_DWT_rec(2,50:550)==max(-Xica_DWT_rec(2,50:550))))+49;
        ampFormact.right.N2(count,stim)=(find(-Xica_DWT_rec(2,1300:1900)==min(-Xica_DWT_rec(2,1300:1900))))+1299;
        ampFormact.right.N2_val(count,stim)=-Xica_DWT_rec(2,ampFormact.right.N2(count,stim));
        ampFormact.right.picos(count,stim)=(find(-Xica_DWT_rec(2,500:1500)==max(-Xica_DWT_rec(2,500:1500))))+499;
        ampFormact.right.diffsp1(count,stim)= -Xica_DWT_rec(2,ampFormact.right.p1(count,stim))-(-Xica_DWT_rec(2,ampFormact.right.vales(count,stim)));
        ampFormact.right.diffs(count,stim)= -Xica_DWT_rec(2,ampFormact.right.picos(count,stim))-(-Xica_DWT_rec(2,ampFormact.right.vales(count,stim)));
        ampFormact.right.picos_val(count,stim)=-Xica_DWT_rec(2,ampFormact.right.picos(count,stim));
        ampFormact.right.vales_val(count,stim)=-Xica_DWT_rec(2,ampFormact.right.vales(count,stim));
        ampFormact.right.p1_val(count,stim)=-Xica_DWT_rec(2,ampFormact.right.p1(count,stim));
        ...
        ampFormact.right.meio_val(count,stim)=-Xica_DWT_rec(2,(ampFormact.right.vales(count,stim)+round((ampFormact.right.picos(count,stim)-ampFormact.right.vales(count,stim))/2)));
                
        ampFormact.left.vales(count,stim)=(find(-Xica_DWT_rec(17,mN1:1000)==min(-Xica_DWT_rec(17,mN1:1000))))+(mN1-1);
        ampFormact.left.p1(count,stim)=(find(-Xica_DWT_rec(17,50:550)==max(-Xica_DWT_rec(17,50:550))))+49;
        ampFormact.left.N2(count,stim)=(find(-Xica_DWT_rec(17,1300:1900)==min(-Xica_DWT_rec(17,1300:1900))))+1299;
        ampFormact.left.N2_val(count,stim)=-Xica_DWT_rec(17,ampFormact.right.N2(count,stim));
        ampFormact.left.picos(count,stim)=(find(-Xica_DWT_rec(17,500:1500)==max(-Xica_DWT_rec(17,500:1500))))+499;
        ampFormact.left.diffsp1(count,stim)= -Xica_DWT_rec(17,ampFormact.left.p1(count,stim))-(-Xica_DWT_rec(17,ampFormact.left.vales(count,stim)));
        ampFormact.left.diffs(count,stim)= -Xica_DWT_rec(17,ampFormact.left.picos(count,stim))-(-Xica_DWT_rec(17,ampFormact.left.vales(count,stim)));
        ampFormact.left.picos_val(count,stim)=-Xica_DWT_rec(17,ampFormact.left.picos(count,stim));
        ampFormact.left.vales_val(count,stim)=-Xica_DWT_rec(17,ampFormact.left.vales(count,stim));
        ampFormact.left.p1_val(count,stim)=-Xica_DWT_rec(17,ampFormact.left.p1(count,stim));
        ...
        ampFormact.left.meio_val(count,stim)=-Xica_DWT_rec(17,(ampFormact.left.vales(count,stim)+round((ampFormact.left.picos(count,stim)-ampFormact.left.vales(count,stim))/2)));
...
for i=1:5
    ...
    subplot(1,2,1)
    plot(t,-Xica_DWT_rec(17,:),col{i})
    title('Left')
    grid
    hold on
    
    subplot(1,2,2)
    plot(t,-Xica_DWT_rec(2,:),col{i})
    title('Right')
    Leg{i}=sprintf('%d',i);
    grid
    hold on
...
for i=1:5
    ...
    Xica_DWT_rec=Xica_DWT_rec(:,501:end);
    XicaMat(1,j,:)=-((Xica_DWT_rec(17,:)-medR)/sdR);
    XicaMat(2,j,:)=-((Xica_DWT_rec(2,:)-medR)/sdR);
    end
...
nbeta=[bt(1,:) bt(1,:)]; %bt(1,:) para VOT e bt(2,:) para formantes
val(1:18,1:5)=0;
for s=1:5
nome=[ampVOTact.left.vales_val(:,s);ampVOTact.right.vales_val(:,s)];
subplot(5,1,s)
format long
...
val(:,s)=(polyval(b,nome)-nbeta');%para avaliar resíduos
hold off
...
xlabel('Stim1~Stim5 (uV)')
ylabel('Beta')
title(sprintf('Form active R2: %.4f p-value:%.4f', R2(2,1),p(2,1)))
...
%orient(figure(14),'landscape')
%print(figure(14),'N1.pdf','-dpdf')